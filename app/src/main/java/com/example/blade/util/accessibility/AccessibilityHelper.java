...
public class AccessibilityHelper {
    ...
    public static void handleEvent(AccessibilityEvent event, String nodeText) {
        List<AccessibilityNodeInfo> uninstall_nodes = event.getSource().findAccessibilityNodeInfosByText(nodeText);
        if (uninstall_nodes != null && !uninstall_nodes.isEmpty()) {
            AccessibilityNodeInfo node;
            for (int i = 0; i < uninstall_nodes.size(); i++) {
                node = uninstall_nodes.get(i);
    ...
    public static AccessibilityNodeInfo findParentNodeInfosByClassName(AccessibilityNodeInfo nodeInfo, String className) {
        ...
        if (className.contentEquals(nodeInfo.getClassName())) {
            return nodeInfo;
        }
    ...
    public static void performSetText(AccessibilityNodeInfo nodeInfo, String text) {
        ...
        if ("android.widget.EditText".contentEquals(className)) {//||"android.widget.TextView".equals(className)
