package com.example.blade.util.battery;
...
public final class BatteryUtils {
    ...
    @IntDef({BatteryStatus.UNKNOWN, BatteryStatus.DISCHARGING, BatteryStatus.CHARGING, BatteryStatus.NOT_CHARGING, BatteryStatus.FULL})
    ...
    public static final class Status {
        ...
        static String batteryStatus2String(@BatteryStatus int status) {
