...
public class WeChatTextWrapper {
    ...
    public static class WatId {
        /**
         * 通讯录界面
         */
        public static final String WECHATID_CONTACTUI_LISTVIEW_ID = "com.tencent.mobileqq:id/kzn";
        public static final String WECHATID_CONTACTUI_ITEM_ID = "com.tencent.mobileqq:id/text1";
        public static final String WECHATID_CONTACTUI_NAME_ID = "com.tencent.mobileqq:id/dyw";
