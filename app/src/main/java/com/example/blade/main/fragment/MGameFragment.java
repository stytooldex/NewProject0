...
import com.example.blade.main.fragment.management.MGame;
...
import static com.example.blade.main.fragment.management.MGame.MGame_items;

public class MGameFragment extends BaseRecyclerFragment {


    @Override
    protected ArrayList<Daily> data() {
        ArrayList<Daily> arrayList = new ArrayList<>();
        arrayList.add(new Daily(MGame_items[0], "content"));
        arrayList.add(new Daily(MGame_items[1], "content"));
        arrayList.add(new Daily(MGame_items[2], "content"));
        arrayList.add(new Daily(MGame_items[3], "content"));
        return arrayList;
    }
    ...
    public void onItemClick(@NonNull BaseQuickAdapter adapter, @NonNull View view, int position) {
        ...
        Permits.iniQ(requireActivity(), () -> MGame.INSTANCE.execute(requireActivity(), string), STORAGE);
    }
}
